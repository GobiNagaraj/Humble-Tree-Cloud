{{-- Header Section Included Here --}}
@include('frontend.layouts.includes.header')

	{{-- Menu Bar Section Included Here --}}
    @include('frontend.layouts.includes.menu')

    @yield('main-content')
    <div class="hero-wrap js-fullheight" style="background-image: url('{{ asset('frontend/assets/images/bg_1.jpg') }}');" data-stellar-background-ratio="0.5">
    	...
    	<div class="container">
    		<div class="row d-flex">
    			<div class="col-md-6 d-flex">
    				<div class="img d-flex align-self-stretch" style="background-image:url({{ asset('frontend/assets/images/about.jpg')}});"></div>
    			</div>
        ...
        <div class="row">
        	<div class="col-md-12 ftco-animate">
        		<div class="carousel-testimony owl-carousel">
        			<div class="item">
        				<div class="speaker">
			        		<img src="{{ asset('frontend/assets/images/speaker-1.jpg') }}" class="img-fluid" alt="Colorlib HTML5 Template">
        			...
        			<div class="item">
        				<div class="speaker">
			        		<img src="{{ asset('frontend/assets/images/speaker-2.jpg') }}" class="img-fluid" alt="Colorlib HTML5 Template">
			        		<div class="text text-center py-3">
			        			<h3>Paul George</h3>
			        			<span class="position">Web Developer</span>
			        			<ul class="ftco-social mt-3">
        			...
        			<div class="item">
        				<div class="speaker">
			        		<img src="{{ asset('frontend/assets/images/speaker-3.jpg') }}" class="img-fluid" alt="Colorlib HTML5 Template">
			        		<div class="text text-center py-3">
			        			<h3>James Smith</h3>
			        			<span class="position">Web Developer</span>
			        			<ul class="ftco-social mt-3">
        			...
        			<div class="item">
        				<div class="speaker">
			        		<img src="{{ asset('frontend/assets/images/speaker-4.jpg') }}" class="img-fluid" alt="Colorlib HTML5 Template">
			        		<div class="text text-center py-3">
        			...
        			<div class="item">
        				<div class="speaker">
			        		<img src="{{ asset('frontend/assets/images/speaker-5.jpg') }}" class="img-fluid" alt="Colorlib HTML5 Template">
			        		<div class="text text-center py-3">
			        			<h3>Jackie Spears</h3>
	            ...
	            <div class="tab-content" id="v-pills-tabContent">
	              ...
	              <div class="tab-pane fade show active" id="v-pills-1" role="tabpanel" aria-labelledby="day-1-tab">
	              	<div class="speaker-wrap ftco-animate d-flex">
	              		<div class="img speaker-img" style="background-image: url({{ asset('frontend/assets/images/person_1.jpg') }});"></div>
	              	...
	              	<div class="speaker-wrap ftco-animate d-flex">
	              		<div class="img speaker-img" style="background-image: url({{ asset('frontend/assets/images/person_2.jpg') }});"></div>
	              		<div class="text pl-md-5">
	              			<span class="time">08: - 10:00</span>
	              	...
	              	<div class="speaker-wrap ftco-animate d-flex">
	              		<div class="img speaker-img" style="background-image: url({{ asset('frontend/assets/images/person_3.jpg') }});"></div>
	              		<div class="text pl-md-5">
	              			<span class="time">08: - 10:00</span>
            ...
            <div class="carousel-testimony owl-carousel ftco-owl">
              <div class="item">
                <div class="testimony-wrap text-center py-4 pb-5">
                  <div class="user-img mb-4" style="background-image: url({{ asset('frontend/assets/images/person_1.jpg') }})">
              ...
              <div class="item">
                <div class="testimony-wrap text-center py-4 pb-5">
                  <div class="user-img mb-4" style="background-image: url({{ asset('frontend/assets/images/person_2.jpg') }})">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                  </div>
              ...
              <div class="item">
                <div class="testimony-wrap text-center py-4 pb-5">
                  <div class="user-img mb-4" style="background-image: url({{ asset('frontend/assets/images/person_3.jpg') }})">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                  </div>
    	...
    	<div class="container-wrap">
    		<div class="row no-gutters">
					<div class="col-md-3 ftco-animate">
						<a href="{{ asset('frontend/assets/images/image_1.jpg') }}" class="gallery image-popup img d-flex align-items-center" style="background-image: url({{ asset('frontend/assets/images/image_1.jpg') }});">
					...
					<div class="col-md-3 ftco-animate">
						<a href="{{ asset('frontend/assets/images/image_2.jpg') }}" class="gallery image-popup img d-flex align-items-center" style="background-image: url({{ asset('frontend/assets/images/image_2.jpg') }});">
							<div class="icon mb-4 d-flex align-items-center justify-content-center">
    						<span class="icon-instagram"></span>
    					</div>
						</a>
					...
					<div class="col-md-3 ftco-animate">
						<a href="{{ asset('frontend/assets/images/image_3.jpg') }}" class="gallery image-popup img d-flex align-items-center" style="background-image: url({{ asset('frontend/assets/images/image_3.jpg') }});">
							<div class="icon mb-4 d-flex align-items-center justify-content-center">
    						<span class="icon-instagram"></span>
    					</div>
						</a>
					...
					<div class="col-md-3 ftco-animate">
						<a href="{{ asset('frontend/assets/images/image_4.jpg') }}" class="gallery image-popup img d-flex align-items-center" style="background-image: url({{ asset('frontend/assets/images/image_4.jpg') }});">
							<div class="icon mb-4 d-flex align-items-center justify-content-center">
    						<span class="icon-instagram"></span>
    					</div>
						</a>
