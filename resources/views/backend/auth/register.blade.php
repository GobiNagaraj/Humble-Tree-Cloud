...
<body>
  <div class="login-form">
    <form action="{{ URL::to('/backend/auth/store') }}" method="POST">
        @csrf
      <h1>Register</h1>
        {{-- @if ($errors->any())
       ...
       <div class="imgcontainer">
            <img src="https://png.pngitem.com/pimgs/s/516-5168760_upload-avatar-upload-avatar-png-transparent-png.png" alt="Avatar" class="avatar">
      </div>
      <div class="form-group">
        <input type="text" name="user_name" placeholder="User Name" class="form-control @if($errors->has('user_name')) {{'is-invalid'}} @endif">
      ...
      <a class="reset-psw" href="{{ URL::to('/backend/login') }}">Click here to Login</a>
